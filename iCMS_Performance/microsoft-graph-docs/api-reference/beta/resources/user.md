...
|[Abrufen von Einstellungen für automatische Antworten](../api/user_get_mailboxsettings.md) |[automaticRepliesSetting](../resources/automaticRepliesSetting.md) | Rufen Sie die Einstellungen für Personen automatisch beim Empfang von e-Mails benachrichtigen. |
|[Aktualisieren der Einstellungen für automatische Antworten](../api/user_update_mailboxsettings.md) |[mailboxSettings](../resources/mailboxSettings.md) | Aktualisieren Sie die Einstellungen für die Benachrichtigung Personen automatisch beim Empfang von e-Mails. |
...
|[Liste Mitglied](../api/user_list_memberof.md) |[DirectoryObject](directoryobject.md) -Auflistung| Rufen Sie die Gruppen, Directory Rollen und administrative Einheiten, die der Benutzer ein direktes Mitglied in der Navigationseigenschaft Mitglied ist.|
...
|[Liste scopedAdministratorOf](../api/user_list_scopedadministratorof.md) |[ScopedRoleMembership](scopedrolemembership.md) -Auflistung| Rufen Sie die administrative bezogenen Rolle Einheiten Mitgliedschaften für diesen Benutzer.|
...
|[findmeetingtimes](../api/user_findmeetingtimes.md)|[meetingTimeCandidate](meetingtimecandidate.md)|Besuchen Sie Zeit und Speicherorte erfüllen basierend auf Teilnehmer Verfügbarkeit, Standort oder Zeit Einschränkungen.|
...
|[getMemberObjects](../api/user_getmemberobjects.md)|Zeichenfolgenauflistung| Zurückgeben Sie aller Gruppen, Directory Rollen und administrative Einheiten, denen der Benutzer Mitglied ist. Die Überprüfung ist transitiv. |
...
|mailboxSettings|[mailboxSettings](mailboxsettings.md)|Einstellungen für das primäre Postfach des angemeldeten Benutzers. Dazu gehören Einstellungen für automatische Antworten auf eingehende Nachrichten senden.|
