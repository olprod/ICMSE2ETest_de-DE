...
|meetingMessageType|String| Den Typ der ereignismeldung: `None`, `MeetingRequest`, `MeetingCancelled`, `MeetingAccepted`, `MeetingTenativelyAccepted`, `MeetingDeclined`.|
...
|Ereignis|[Ereignis](event.md)| Das Ereignis mit der Nachrichten-Ereignis verknüpft ist. Die Annahme für Teilnehmer oder raumressourcen ist, dass der Kalenderautomatik festgelegt ist, im Kalender mit ein Ereignis, wenn einer Besprechungsanfrage, dass Ereignisnachrichten eintreffen automatisch aktualisiert wird. Navigationseigenschaft.  Schreibgeschützt.|
...
|[Anlage erstellen](../api/eventmessage_post_attachments.md) |[Anlage](attachment.md)| Erstellen Sie eine neue Anlage, indem Sie das Veröffentlichen in der Attachments-Auflistung.|
...
|[Update](../api/eventmessage_update.md) | [eventMessage](eventmessage.md)  |EventMessage-Objekt zu aktualisieren. |
...
|[Verschieben](../api/message_move.md)|[Nachricht](message.md)|Verschieben der Nachricht in einer MailFolder.|
