# <a name="list-scopedadministratorof"></a>Liste scopedAdministratorOf

Abrufen einer Liste der [ScopedRoleMembership](../resources/scopedrolemembership.md) für den Benutzer.
## <a name="prerequisites"></a>Voraussetzungen
Der folgende **Bereiche** sind erforderlich, um diese API ausführen: *Directory.Read.All* oder *Directory.ReadWrite.All* oder *Directory.AccessAsUser.All*
