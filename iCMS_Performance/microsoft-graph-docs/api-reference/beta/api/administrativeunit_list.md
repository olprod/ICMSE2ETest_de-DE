...
Rufen Sie eine Liste der [AdministrativeUnit](../resources/administrativeunit.md) Objekte ab.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten in der Antworttext [AdministrativeUnit](../resources/administrativeunit.md) .
