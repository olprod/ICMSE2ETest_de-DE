...
Erstellen Sie ein [Ereignis](../resources/event.md) im Kalender des Benutzers. 

Sie können die Zeitzone für jede der Start- und Endzeiten des Ereignisses im Rahmen dieser Werte angeben, wie die Eigenschaften **start** und **End** vom Typ [DateTimeTimeZone](../resources/datetimetimezone.md) sind. 
