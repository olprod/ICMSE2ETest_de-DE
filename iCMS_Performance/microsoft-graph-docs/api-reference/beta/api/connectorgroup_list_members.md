...
Abrufen einer Liste der Connector-Objekte mit einem ConnectorGroup verknüpft ist.
...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [Connector](../resources/connector.md) .
