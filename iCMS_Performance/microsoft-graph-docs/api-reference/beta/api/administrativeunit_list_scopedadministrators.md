# <a name="list-scopedadministrators"></a>Liste scopedAdministrators

Abrufen einer Liste von [ScopedRoleMembership](../resources/scopedrolemembership.md) -Objekten.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten in der Antworttext [ScopedRoleMembership](../resources/scopedrolemembership.md) .
