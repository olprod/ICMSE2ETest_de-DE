...
Abrufen einer Liste von [Section](../resources/section.md) -Objekten aus der angegebenen Abschnittsgruppe.
...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortcode und eine Auflistung von [Section](../resources/section.md) -Objekten in der Antworttext.
