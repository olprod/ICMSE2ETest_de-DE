...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortobjekt Code und [ImpossibleTravelRiskEvent](../resources/impossibletravelriskevent.md) im Antworttext.
