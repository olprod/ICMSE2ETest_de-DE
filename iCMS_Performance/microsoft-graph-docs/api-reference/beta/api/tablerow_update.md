...
Aktualisieren Sie die Eigenschaften des Tablerow-Objekts.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und aktualisierte [TableRow](../resources/tablerow.md) -Objekts in der Antworttext.
