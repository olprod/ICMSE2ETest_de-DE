...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortcode und Auflistung von [oAuth2Permissiongrant](../resources/oAuth2Permissiongrant.md) -Objekten im Antworttext.
