...
Abrufen der Eigenschaften und Beziehungen zwischen Kontaktobjekt.
...
|:---------------|:--------|:-------|
|$Erweitern|Zeichenfolge|Durch Trennzeichen getrennte Liste von Beziehungen zu erweitern und in der Antwort enthalten. Finden Sie unter Beziehungstabelle des Objekts für unterstützte Namen [wenden Sie sich an](../resources/contact.md) . |
...
Wenn der Vorgang erfolgreich war, gibt diese Methode eine `200 OK` Antwortobjekt Code, und [wenden Sie sich](../resources/contact.md) im Antworttext.
