...
Ruft ein Border-Objekt über diesen index
...
Wenn der Vorgang erfolgreich war, gibt diese Methode `200, OK` Antwortcode und [RangeBorder](../resources/rangeborder.md) -Objekts in der Antworttext.
