# <a name="update-taskdetails"></a>Update taskdetails

Aktualisieren Sie die Eigenschaften des Taskdetails-Objekts.
...
|:---------------|:--------|:----------|
|Prüfliste|[checklistItemCollection](../resources/checklistitemcollection.md)|Die Auflistung der Prüfliste Elemente für den Vorgang.|
...
|Verweise|[externalReferenceCollection](../resources/externalreferencecollection.md)|Die Auflistung der Verweise auf die Aufgabe. |
