...
Aktualisieren Sie die Eigenschaften des Chartfont-Objekt.
...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortcode und aktualisierte [ChartFont](../resources/chartfont.md) -Objekts in der Antworttext.
