...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortcode und Auflistung von [ConnectorGroup](../resources/connectorgroup.md) -Objekte in der Antworttext.
