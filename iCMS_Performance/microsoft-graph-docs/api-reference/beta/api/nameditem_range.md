# <a name="nameditem-range"></a>GetNamedItem: Bereich

Gibt das Range-Objekt, das mit dem Namen zugeordnet ist. Löst eine Ausnahme aus, wenn das benannte Element Typ kein Bereich ist.
