# <a name="get-rangeborder"></a>Abrufen von RangeBorder

Rufen Sie die Eigenschaften und Beziehungen Rangeborder-Objekts ab.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und [RangeBorder](../resources/rangeborder.md) -Objekts in der Antworttext.
