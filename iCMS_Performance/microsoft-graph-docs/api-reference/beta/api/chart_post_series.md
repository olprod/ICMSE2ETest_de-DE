# <a name="create-chartseries"></a>Erstellen von ChartSeries
...
Wenn der Vorgang erfolgreich war, gibt diese Methode `201, Created` Antwortcode und [ChartSeries](../resources/chartseries.md) -Objekts in der Antworttext.
