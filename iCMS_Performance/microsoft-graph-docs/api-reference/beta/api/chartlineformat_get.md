# <a name="get-chartlineformat"></a>Abrufen von ChartLineFormat

Rufen Sie die Eigenschaften und Beziehungen des Chartlineformat-Objekts ab.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und [ChartLineFormat](../resources/chartlineformat.md) -Objekts in der Antworttext.
