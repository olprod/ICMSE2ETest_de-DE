...
Aktualisieren Sie die Eigenschaften des Icon-Objekt.
...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortcode und aktualisierten [Icon](../resources/icon.md) -Objekt aus der Antwort.
