# <a name="get-chartgridlines"></a>Abrufen von ChartGridlines

Rufen Sie die Eigenschaften und Beziehungen Chartgridlines-Objekts ab.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und [ChartGridlines](../resources/chartgridlines.md) -Objekts in der Antworttext.
