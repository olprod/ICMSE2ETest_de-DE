# <a name="contact-resource-type"></a>contact resource type
...
|:---------------|:--------|:----------|
|[Get contact](../api/contact_get.md) | [Kontaktperson](contact.md) |Read properties and relationships of contact object.|
|[create](../api/user_post_contacts.md) | [Kontaktperson](contact.md) |Add a contact to the root Contacts folder or to the contacts endpoint of another contact folder.|
|[Update](../api/contact_update.md) | [Kontaktperson](contact.md) |Update contact object. |
|[delete()](../api/contact_delete.md) | Keine |Delete contact object. |
...
|Kategorien|String collection|The categories associated with the contact.|
|changeKey|String|Identifies the version of the contact. Every time the contact is changed, ChangeKey changes as well. This allows Exchange to apply changes to the correct version of the object.|
|Kinder|String collection|The names of the contact's children.|
...
|Eigenschaft emailAddresses|[EmailAddress](emailaddress.md) collection|The contact's email addresses.|
