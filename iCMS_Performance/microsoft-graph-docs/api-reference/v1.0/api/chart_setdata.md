...
|seriesBy|string|Optional Gibt an, dass die Möglichkeit Spalten und Zeilen als Datenreihen im Diagramm verwendet werden. Kann eine der folgenden sein: automatisch (Standardeinstellung), Zeilen, Spalten.  Mögliche Werte sind: `Auto`, `Columns`, `Rows`.|
