...
Abrufen eines Punkts basierend auf ihre Position in der Datenreihe an.
...
Wenn erfolgreich ist, diese Methode gibt `200, OK` Antwortcode und [ChartPoint](../resources/chartpoint.md) -Objekts in der Antworttext.
