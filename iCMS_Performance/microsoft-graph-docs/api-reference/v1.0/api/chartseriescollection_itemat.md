...
Ruft eine Reihe basierend auf seine Position in der Auflistung
...
Wenn erfolgreich ist, diese Methode gibt `200, OK` Antwortcode und [ChartSeries](../resources/chartseries.md) -Objekts in der Antworttext.
