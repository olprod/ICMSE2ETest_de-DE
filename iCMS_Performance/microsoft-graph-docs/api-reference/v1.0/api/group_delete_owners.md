# <a name="remove-owner"></a>Entfernen der Besitzer

Verwenden Sie diese API, um einen Besitzer aus einer Office 365, eine Sicherheitsgruppe oder eine e-Mail-aktivierte Sicherheitsgruppe über die Besitzer Navigation-Eigenschaft zu entfernen.
