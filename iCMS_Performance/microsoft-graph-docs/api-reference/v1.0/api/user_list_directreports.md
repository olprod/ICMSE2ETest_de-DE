# <a name="list-directreports"></a>Liste directReports

Mitarbeiter des Benutzers abzurufen. Gibt die Benutzer und Kontakte, die dieser Benutzer als Manager zugewiesen ist.
