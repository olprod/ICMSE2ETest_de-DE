...
Aktualisieren Sie die Eigenschaften des Chartlineformat-Objekts.
...
Wenn erfolgreich, diese Methode gibt eine `200 OK` Antwortcode und aktualisierte [ChartLineFormat](../resources/chartlineformat.md) -Objekts in der Antworttext.
