...
Rufen Sie die Eigenschaften und Beziehungen Tablecolumn-Objekts ab.
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und [TableColumn](../resources/tablecolumn.md) -Objekts in der Antworttext.
