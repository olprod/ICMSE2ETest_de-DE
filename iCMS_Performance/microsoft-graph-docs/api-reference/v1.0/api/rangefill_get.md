# <a name="get-rangefill"></a>Abrufen von RangeFill

Rufen Sie die Eigenschaften und Beziehungen des Rangefill-Objekts ab.
...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortcode und [RangeFill](../resources/rangefill.md) -Objekts in der Antworttext.
