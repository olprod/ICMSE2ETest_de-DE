...
Positioniert das Diagramm relativ zur Zellen auf dem Arbeitsblatt.
...
|:---------------|:--------|:----------|
|startCell|string|Die Start-Zelle. Dies ist, auf dem das Diagramm in verschoben werden sollen. Die Start-Zelle ist die Zelle oben links oder rechts oben je nach den Einstellungen des Benutzers rechts-nach-links-Anzeige.|
