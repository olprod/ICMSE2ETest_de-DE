...
Rufen Sie die Eigenschaften und Beziehungen Chartfont-Objekts ab.
...
Wenn erfolgreich, diese Methode gibt eine `200 OK` Antwortcode und [ChartFont](../resources/chartfont.md) -Objekt aus der Antwort.
