# <a name="list-borders"></a>Listenrahmen
...
Wenn der Vorgang erfolgreich war, gibt diese Methode einen `200 OK` Antwortcode und Auflistung von Objekten im Antworttext [RangeBorder](../resources/rangeborder.md) .
