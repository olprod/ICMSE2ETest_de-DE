...
Abrufen der Eigenschaften und Beziehungen zwischen Attachment-Objekt.
...
Wenn erfolgreich ist, diese Methode gibt einen `200 OK` Antwortobjekt Code als auch der [Anlage](../resources/attachment.md) im Antworttext.
