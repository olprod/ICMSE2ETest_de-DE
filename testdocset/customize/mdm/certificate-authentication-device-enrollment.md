---
title: "Registrierung von Zertifikaten Authentifizierung Gerät"
description: "Dieser Abschnitt enthält ein Beispiel des mobilen Geräts Registrierung-Protokolls Authentifizierungsrichtlinie Zertifikat verwenden."
MSHAttr:
...
translationtype: MT
---
# <a name="certificate-authentication-device-enrollment"></a>Registrierung von Zertifikaten Authentifizierung Gerät


Dieser Abschnitt enthält ein Beispiel des mobilen Geräts Registrierung-Protokolls Authentifizierungsrichtlinie Zertifikat verwenden. Ausführliche Informationen zu Microsoft Mobilgerät Registrierungs-Protokoll für Windows 10, finden Sie unter [ \[MS-MDE2\]: Mobile Device Registrierung Protocol Version 2]( http://go.microsoft.com/fwlink/p/?LinkId=619347).

> **Hinweis**  Um Geräte für Zertifikatauthentifizierung für die Registrierung verwenden, sollten Sie ein Paket provisioning erstellen. Weitere Informationen zu provisioning Paketen finden Sie unter [Erstellen und anwenden ein provisioning-Pakets](https://msdn.microsoft.com/library/windows/hardware/dn916107).
...
-   [Registrierung-Webdienst](#enrollment-web-service)
...
Das folgende Beispiel zeigt die Discovery-Dienst Antwort.
...
## <a name="enrollment-policy-web-service"></a>Registrierungs-Webdienst
...
Der folgende Codeausschnitt zeigt die Webdienstantwort Richtlinie.
...
Das folgende Beispiel zeigt die Registrierung Web Service-Anforderung.
...
Das folgende Beispiel zeigt die Registrierung Webdienstantwort.
