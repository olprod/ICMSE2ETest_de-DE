---
title: SUPL DDF-Datei
description: "In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für SUPL-Konfiguration."
MSHAttr:
...
translationtype: MT
---
# <a name="supl-ddf-file"></a>SUPL DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den **SUPL** Konfigurationsdienstanbieter.
