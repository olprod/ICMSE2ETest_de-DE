---
title: NodeCache DDF-Datei
description: NodeCache DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="nodecache-ddf-file"></a>NodeCache DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **NodeCache** -Konfiguration. DDF-Dateien werden nur mit OMA DM Bereitstellung von XML verwendet.
...
[NodeCache Konfigurationsdienstanbieter](nodecache-csp.md)
