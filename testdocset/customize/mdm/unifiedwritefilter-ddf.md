---
title: UnifiedWriteFilter DDF-Datei
description: UnifiedWriteFilter DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="unifiedwritefilter-ddf-file"></a>UnifiedWriteFilter DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **UnifiedWriteFilter** -Konfiguration. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
