---
title: EMAIL2 DDF-Datei
description: EMAIL2 DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="email2-ddf-file"></a>EMAIL2 DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **EMAIL2** -Konfiguration. DDF-Dateien werden nur mit OMA DM Bereitstellung von XML verwendet.
...
[EMAIL2 Konfigurationsdienstanbieter](email2-csp.md)
