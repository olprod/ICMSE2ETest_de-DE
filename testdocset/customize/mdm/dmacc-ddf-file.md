---
title: DMAcc DDF-Datei
description: DMAcc DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="dmacc-ddf-file"></a>DMAcc DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **DMAcc** -Konfiguration. DDF-Dateien werden nur mit OMA DM Bereitstellung von XML verwendet.
...
[DMAcc Konfiguration-Dienstanbieter](dmacc-csp.md)
