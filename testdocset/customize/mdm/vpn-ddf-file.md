...
translationtype: MT
---
# <a name="vpn-ddf-file"></a>VPN DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **VPN** -Konfiguration. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
...
[VPN-Configurtion-Dienstanbieter](vpn-csp.md)
