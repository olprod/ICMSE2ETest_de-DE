...
Der Dienstanbieter für AppLocker Konfiguration wird verwendet, um anzugeben, welche Anwendungen zugelassen oder nicht zulässig sind. Es ist keine Benutzeroberfläche für apps, die blockiert werden angezeigt.

> **Hinweis**  
> Wenn Sie eine Liste der zulässigen apps erstellen, werden auch alle [Posteingang apps](#inboxappsandcomponents) blockiert, und muss in der Liste der zulässigen apps einbinden. Vergessen Sie nicht, fügen Sie der Posteingang apps für Telefon, Messaging, Einstellungen, Start-, E-Mail und Konten, Arbeit und Schule und andere apps, die Sie benötigen.
>
> In Windows 10 Mobile Wenn Sie eine Liste der zulässigen apps erstellen werden der [Settings-app, die sich auf dem Begrüßungsbildschirm Apps,](#settingssplashapps) blockiert. Um diese apps Blockierung aufheben, müssen Sie sie in der Liste der zulässigen apps einschließen.
> 
> Delete/Unenrollment wird nicht ordnungsgemäß unterstützt, es sei denn, die Gruppierungswerte für diesen eindeutig sind. Wenn mehrere wichtige den gleichen Wert für die Gruppierung verwenden, klicken Sie dann funktioniert Unenrollment nicht wie erwartet, da es gibt doppelte URIs, die von der Ressourcen-Manager gelöscht. Um dieses Problem zu verhindern, sollte der Gruppierungswert einige Zufälligkeit enthalten. Bewährt hat eine willkürlich generierte GUID verwendet. Es ist jedoch nicht erforderlich auf dem genauen Wert des Knotens.


Das folgende Diagramm zeigt den AppLocker Konfigurationsdienstanbieter im Strukturformat dar.

![AppLocker csp](images/provisioning-csp-applocker.png)

<a href="" id="--vendor-msft-applocker"></a>**./Vendor/MSFT/AppLocker**  
Definiert den Stammknoten für den Dienstanbieter für AppLocker-Konfiguration.

<a href="" id="applicationlaunchrestrictions"></a>**ApplicationLaunchRestrictions**  
Einschränkungen für Applikationen definiert.

> **Hinweis**  
> Wenn Sie eine Liste der zulässigen apps erstellen, werden auch alle [Posteingang apps](#inboxappsandcomponents) blockiert, und muss in der Liste der zulässigen apps einbinden. Vergessen Sie nicht, die den Posteingang von apps für Telefon, Messaging, Einstellungen, Start-, E-Mail und Konten, Arbeit und Schule und andere apps, die Sie benötigen.
> 
> In Windows 10 Mobile Wenn Sie eine Liste der zulässigen apps erstellen werden der [Settings-app, die sich auf dem Begrüßungsbildschirm Apps,](#settingssplashapps) blockiert. Um diese apps Blockierung aufheben, müssen Sie sie in der Liste der zulässigen apps einschließen.

Zusätzliche Informationen:

- [Hier finden Sie Publisher und Produktname Apps](#productname) - schrittweise Anleitung für das Abrufen der Herausgeber und das Produkt Namen für verschiedene Windows-apps.
- [Weiße Beispiel](#whitelist-example) - Beispiel für Windows 10 Mobile, die alle apps außer den aufgeführten verweigert.

<a href="" id="enterprisedataprotection"></a>**EnterpriseDataProtection**  
Erfasst die Liste der apps, die zum Verarbeiten von Daten zu Enterprise zulässig sind. Sollte in Verbindung mit den Einstellungen in **./Device/Vendor/MSFT/EnterpriseDataProtection** im [Bereich CSP EnterpriseDataProtection](enterprisedataprotection-csp.md)verwendet werden.

Zusätzliche Informationen:

- [Empfohlene verweigern Liste für Windows Information Protection](#recommended-deny-list-for-windows-information-protection) - Beispiel für Windows 10, Version 1607, die verweigert bezeichnet unenlightened Microsoft-apps auf Enterprise-Daten als eine zulässige app zugreifen. Dadurch wird sichergestellt, ein Administrator nicht versehentlich stellen diese apps Windows Information Protection zulässig, und Kompatibilität bekannten Probleme im Zusammenhang mit der automatischen Datei Verschlüsselung mit diese Anwendungen vermeiden.

Jede der oben genannten Knoten enthält einen Knoten **Gruppierung** .
...
<tbody>
<tr class="odd">
<td><p><strong>Gruppierung</strong></p></td>
<td><p>Gruppierung Knoten werden dynamische Knoten, und kann eine beliebige Anzahl von ihnen für einen bestimmten Registrierung (oder einen bestimmten Kontext) vorhanden sein. Die tatsächlichen Bezeichner ausgewählt sind, vom Management Endpunkt, dessen Auftrag es ist, um zu bestimmen, welche wird dafür gesorgt, und nicht Konflikt mit anderen Bezeichnern an, denen sie definieren.</p>
<p>Registrierung für die verschiedenen und Kontexte möglicherweise den gleichen Zertifizierungsstelle Bezeichner verwenden, auch wenn viele dieser Bezeichner gleichzeitig aktiv sind.</p>
<p>Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
</tbody>
</table>
...
Darüber hinaus enthält jeder Knoten **Gruppierung** eine oder mehrere der folgenden Knoten:
...
<tbody>
<tr class="odd">
<td><p><strong>EXE-DATEI</strong></p></td>
<td><p>Definiert die Einschränkungen für ausführbare Anwendung starten.</p>
<p>Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
<tr class="even">
<td><p><strong>MSI-DATEI</strong></p></td>
<td><p>Definiert die Einschränkungen für das Ausführen von Windows Installer-Dateien.</p>
<p>Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
<tr class="odd">
<td><p><strong>Script</strong></p></td>
<td><p>Definiert die Einschränkungen für das Ausführen von Skripts.</p>
<p>Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
<tr class="even">
<td><p><strong>StoreApps</strong></p></td>
<td><p>Einschränkungen für die Ausführung von apps aus dem Windows Store definiert.</p>
<p>Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
<tr class="odd">
<td><p><strong>DLL-DATEI</strong></p></td>
<td><p>Definiert die Einschränkungen für die Verarbeitung von DLL-Dateien.</p>
<p>Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
<tr class="even">
<td><p><strong>CodeIntegrity</strong></p></td>
<td><p>Dieser Knoten ist nur auf dem Desktop unterstützt. Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
</tbody>
</table>
...
Jeder der vorherigen Knoten enthält eine oder mehrere der folgenden Endknoten:
...
<tbody>
<tr class="odd">
<td><p><strong>Richtlinie</strong></p></td>
<td><p>Knoten der Richtlinie definieren die Richtlinie zum Starten der ausführbaren Dateien, Windows Installer-Dateien, Skripts, Store- und DLL-Dateien. Der Inhalt eines bestimmten Richtlinie Knotens ist genau das XML-Format für einen RuleCollection-Knoten in der entsprechenden AppLocker XML-Richtlinie.</p>
<p>Richtlinie Knoten handelt es sich um eine Base64-codierte Blob für die Darstellung von binären Richtlinie. Die binäre Richtlinie möglicherweise signiert oder unsigniert sind.</p>
<p>Für CodeIntegrity/Richtlinie, können Sie die [Certutil-codieren](http://go.microsoft.com/fwlink/p/?LinkId=724364) Befehlszeilenprogramm zum Codieren von Base64-Daten.</p>
<p>Datentyp ist Zeichenfolge. Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
<tr class="even">
<td><p><strong>EnforcementMode</strong></p></td>
<td><p>Der Knoten EnforcementMode zum Schutz der Windows-Daten (früher als Enterprise Data Protection bezeichnet) wirkt sich nicht auf das Verhalten der EnterpriseDataProtection aus. Die EDPEnforcementLevel von Richtlinie CSP sollte aktivieren und Deaktivieren des Windows Information Protection (vormals Enterprise Data Protection) verwendet werden.</p>
<p>Der Datentyp ist eine Zeichenfolge. Unterstützte Vorgänge sind Get, hinzufügen, löschen, und ersetzen.</p></td>
</tr>
<tr class="odd">
<td><p><strong>NonInteractiveProcessEnforcement</strong></p></td>
<td><p>Der Datentyp ist eine Zeichenfolge.</p>
<p>Unterstützte Vorgänge sind Get hinzufügen, löschen, und Ersetzen Sie.</p></td>
</tr>
</tbody>
</table>
...
## <a name="a-href-idproductnameafind-publisher-and-product-name-of-apps"></a><a href="" id="productname"></a>Hier finden Sie Publisher und Produktname von apps


Sie können einer Windows Phone (Windows 10 Mobile, Version 1511) auf Ihrem Desktop über das Gerät-Portal auf dem Telefon zum Abrufen der verschiedenen Arten von Informationen, einschließlich den Namen des Herausgebers und Produktname der apps auf dem Telefon installiert aufgebaut. In diesem Verfahren wird beschrieben, Paarung Ihr Telefon auf Ihrem Desktop WiFi verwenden.

Wenn Sie dieses Verfahren nicht funktioniert, versuchen Sie die anderen Methoden für die Bildung von im [Portal für Mobile Geräte](https://msdn.microsoft.com/windows/uwp/debug-test-perf/device-portal-mobile)beschrieben.

**Zum Ermitteln von Publisher und PackageFullName für apps auf Windows 10 Mobile installiert**

1.  Wechseln Sie auf Ihrem Windows Phone- **Einstellungen**. Wählen Sie **Sicherheit & aktualisieren**. Wählen Sie dann **für Entwickler**.
2.  Wählen Sie **den Entwicklermodus**aus.
3.  Aktivieren Sie **Device-Erkennung**.
4.  Aktivieren Sie **Gerät-Portal** , und behalten Sie **AuthenticationOn**.
5.  Klicken Sie unter das **Gerät Portal**unter **eine Verbindung über: WiFi**, kopieren Sie die URL für Ihren desktop Browser für die Verbindung über WiFi.

    Wenn Sie einen Zertifikatfehler erhalten, fahren Sie mit der Webseite.

    Wenn Sie einen Fehler über die Webseite nicht erreichen möchten, sollten Sie anderen Methoden für die Bildung von im [Portal für Mobile Geräte](https://msdn.microsoft.com/windows/uwp/debug-test-perf/device-portal-mobile)beschrieben versuchen.

6.  Tippen Sie auf Ihrem Telefon unter **Gerät Discovery**auf **Paar**. Einen Code erhalten (Groß-/Kleinschreibung beachten).
7.  Geben Sie den Code (Groß-/Kleinschreibung beachten) in das Textfeld im Browser auf der **Seite Access einrichten**und klicken Sie auf **Absenden**.

    Das **Gerät Portal** wird in Ihrem Browser geöffnet.

    ![Gerät Portal screenshot](images/applocker-screenshot1.png)

8.  Klicken Sie auf dem Desktop **Gerät Portal** -Seite auf **Apps** für den **App-Manager**zu öffnen.
9.  Auf der Seite **App-Manager** unter **Ausführen von apps**finden Sie die **Publisher** und **PackageFullName** von apps.

    ![Geräte-Portal app-manager](images/applocker-screenshot3.png)

10. Wenn Sie möchten die app nicht angezeigt wird, suchen Sie unter **installierte apps**. Verwenden das Dropdown-Menü, klicken Sie auf die Anwendung, und Sie erhalten die Version, Publisher und PackageFullName angezeigt.

    ![App-manager](images/applocker-screenshot2.png)

In der folgenden Tabelle anzeigen die Zuordnung der Informationen, die das AppLocker Publisher Regel dar.
...
<thead>
<tr class="header">
<th>Portal Device-Daten</th>
<th>AppLocker Publisher Regel dar</th>
</tr>
</thead>
<tbody>
<tr class="odd">
...
<td><p>ProductName</p>
<p>Der Produktname ist ersten Teil der PackageFullName gefolgt von der Versionsnummer. Im Beispiel Windows Kamera ist die ProductName Microsoft.WindowsCamera an.</p></td>
</tr>
<tr class="even">
...
<td><p>Version</p></td>
<td><p>Version</p>
<p>Dies kann entweder in der HighSection oder LowSection von der BinaryVersionRange verwendet werden.</p>
<p>HighSection definiert die höchste Versionsnummer und LowSection definiert die niedrigste Versionsnummer, die vertrauenswürdig sind. Platzhalter für beide Versionen können Sie um eine Version unabhängige Regel zu erstellen. Verwenden einen Platzhalter für einen der Werte werden höher als oder niedriger als eine bestimmte Version Semantik bereitstellen.</p></td>
</tr>
</tbody>
</table>
...
Es folgt eine Beispiel AppLocker Publisher-Regel:
...
Sie können den Namen des Herausgebers und Produktname von apps unter Verwendung einer API abrufen.

**Zum Ermitteln von Publisher und Produktname für Microsoft-apps in Windows Store for Business**

1.  Wechseln Sie an den Windows Store für Business-Website, und suchen Sie nach Ihrer app. Beispielsweise Microsoft OneNote.
2.  Kopieren Sie den ID-Wert aus der app-URL. Microsoft OneNote ID URL lautet beispielsweise wie Https:<span>< \span > / / www.microsoft.com/store/apps/onenote/9wzdncrfhvjl, und Sie möchten den ID-Wert **9wzdncrfhvjl**Kopie.
3.  Führen Sie in Ihrem Browser des Speichers für die Business Portal Web API, um eine Datei JavaScript Object Notation (JSON) zurückgeben, die Publisher und Product Namenswerte enthält, ein.
    ...
    <tbody>
    <tr class="odd">
    <td><p>{app-ID} https://bspmts.MP.Microsoft.com/v1/Public/Catalog/Retail/Products/ / Applockerdata</p></td>
    </tr>
    </tbody>
    </table>
    ...
    Nachfolgend finden Sie im Beispiel für Microsoft OneNote:
...
<td><p>Denselben Wert ordnet den Namen ProductName und eines vertrauenswürdigen Herausgebers</p>
<p>Dieser Wert wird nur vorhanden sein, wenn ein XAP-Paket im Speicher der app zugeordnet ist.</p>
<p>Wenn dieser Wert einen Wert aufweist wäre das einfache Was tun, um die AppX und die XAP-Paket abdecken zum Erstellen von zwei Regeln für die app. Eine Regel für AppX mithilfe der PackageIdentityName und PublisherCertificateName und einem zweiten verwenden WindowsPhoneLegacyId-Wert.</p></td>
</tr>
</tbody>
</table>
...
## <a name="a-href-idsettingssplashappsasettings-apps-that-rely-on-splash-apps"></a><a href="" id="settingssplashapps"></a>Einstellungen für apps, die auf basieren splash-apps


Wenn Sie eine Liste der zulässigen apps in Windows 10 Mobile erstellen, müssen Sie auch die Teilmenge der Einstellungen für apps einschließen, die Splash-apps in der Liste der zulässigen apps benötigen. Diese apps werden blockiert, es sei denn, sie explizit zur Liste der zulässigen apps hinzugefügt werden. Die folgende Tabelle zeigt einen Teil der Einstellungen für apps, die auf Splash apps verlassen.

Der Produktname ist ersten Teil der PackageFullName gefolgt von der Versionsnummer.

| Einstellungen für app-name                  | PackageFullName oder Produktnamen                                         | Produkt-ID                            |
|------------------------------------|-------------------------------------------------------------------------|--------------------------------------|
| Arbeit oder Schule-Konto             | Microsoft.AAD.BrokerPlugin                                              | e5f8b2c4-75ae-45ee-9be8-212e34f77747 |
| E-Mail- und -Konten                 | Microsoft.AccountsControl                                               | 39cf127b-8c67-c149-539a-c02271d07060 |
| SettingsPageKeyboard               | 5b04b775-356b-4aa0-aaf8-6491ffea5608\_1.1.0.0\_neutrale\_\_cw8ffb7c56vgc | 5b04b775-356b-4aa0-aaf8-6491ffea5608 |
| SettingsPageTimeRegion             | 5b04b775-356b-4aa0-aaf8-6491ffea560c\_1.0.0.0\_neutrale\_\_gqhq4qhgje4fw | 5b04b775-356b-4aa0-aaf8-6491ffea560c |
| SettingsPagePCSystemBluetooth      | 5b04b775-356b-4aa0-aaf8-6491ffea5620\_1.0.0.0\_neutrale\_\_nvaj48k0z8te8 | 5b04b775-356b-4aa0-aaf8-6491ffea5620 |
| SettingsPageNetworkAirplaneMode    | 5b04b775-356b-4aa0-aaf8-6491ffea5621\_1.0.0.0\_neutrale\_\_f73kmnfsk0aj2 | 5b04b775-356b-4aa0-aaf8-6491ffea5621 |
| SettingsPageNetworkWiFi            | 5b04b775-356b-4aa0-aaf8-6491ffea5623\_1.0.0.0\_neutrale\_\_a3jhh70a240gm | 5b04b775-356b-4aa0-aaf8-6491ffea5623 |
| SettingsPageNetworkInternetSharing | 5b04b775-356b-4aa0-aaf8-6491ffea5629\_1.0.0.0\_neutrale\_\_yqcw9dmx6t3pe | 5b04b775-356b-4aa0-aaf8-6491ffea5629 |
| SettingsPageAccountsWorkplace      | 5b04b775-356b-4aa0-aaf8-6491ffea562a\_1.0.0.0\_neutrale\_\_q1wjbr14bc3d0 | 5b04b775-356b-4aa0-aaf8-6491ffea562a |
| SettingsPageRestoreUpdate          | 5b04b775-356b-4aa0-aaf8-6491ffea5640\_1.0.0.0\_neutrale\_\_j77gbj5kz730y | 5b04b775-356b-4aa0-aaf8-6491ffea5640 |
| SettingsPageKidsCorner             | 5b04b775-356b-4aa0-aaf8-6491ffea5802\_1.0.0.0\_neutrale\_\_1wmss2z3sft8c | 5b04b775-356b-4aa0-aaf8-6491ffea5802 |
| SettingsPageDrivingMode            | 5b04b775-356b-4aa0-aaf8-6491ffea5804\_1.0.0.0\_neutrale\_\_t553967svy34g | 5b04b775-356b-4aa0-aaf8-6491ffea5804 |
| SettingsPageTimeLanguage           | 5b04b775-356b-4aa0-aaf8-6491ffea5808\_1.0.0.0\_neutrale\_\_ecxasj38g8ynw | 5b04b775-356b-4aa0-aaf8-6491ffea5808 |
| SettingsPageAppsCorner             | 5b04b775-356b-4aa0-aaf8-6491ffea580a\_1.0.0.0\_neutrale\_\_4vefaa8deck74 | 5b04b775-356b-4aa0-aaf8-6491ffea580a |
| SettingsPagePhoneNfc               | b0894dfd-4671-4bb9-bc17-a8b39947ffb6\_1.0.0.0\_neutrale\_\_1prqnbg33c1tj | b0894dfd-4671-4bb9-bc17-a8b39947ffb6 |

 

## <a name="a-href-idinboxappsandcomponentsainbox-apps-and-components"></a><a href="" id="inboxappsandcomponents"></a>Posteingang apps und Komponenten


Die folgende Liste enthält die apps, die im Posteingang enthalten sein können.

> **Hinweis**  Diese Liste gibt System-apps, die als Teil des Windows geliefert, die Ihre AppLocker-Richtlinie, um sicherzustellen, dass ordnungsgemäße Funktion des Betriebssystems hinzugefügt werden können. Wenn Sie beschließen, diese apps zu blockieren, wird empfohlen, eine sorgfältige Tests vor der Bereitstellung in Ihrer produktionsumgebung. Anderenfalls kann unerwartete Fehler und die Benutzeroberfläche erheblich beeinträchtigen kann.
...
<tr class="odd">
<td>Zugewiesene Access Lock-app</td>
<td>b84f4722-313e-4F85-8f41-cf5417c9c5cb</td>
<td></td>
</tr>
<tr class="even">
<td>Bing Sperre Bilder</td>
<td>5f28c179-2780-41df-b966-27807b8de02c</td>
<td></td>
</tr>
<tr class="odd">
<td>Blockieren und Filtern</td>
...
<tr class="even">
<td>Workerprozess HAP Update im Hintergrund</td>
<td>73c73cdd-4dea-462c-bd83-fa983056a4ef</td>
<td></td>
</tr>
<tr class="odd">
<td>Lumia Motion Daten</td>
...
<tr class="even">
<td>Outlook-Kalender und e-Mail-Nachrichten</td>
...
<tr class="even">
<td>Dialogfeld "Reset" Telefon</td>
...
<tr class="even">
<td>Dialogfeld Bestellung</td>
<td>c60e79ca-063b-4E5D-9177-1309357b2c3f</td>
<td></td>
</tr>
<tr class="odd">
<td>Bewerten Sie Ihr Gerät</td>
...
<tr class="odd">
<td>Speichern der Klingelton</td>
...
<tr class="even">
<td>Tippen Sie auf (Gesten und Touch)</td>
...
<tr class="even">
<td>Windows Standard Sperren des Bildschirms</td>
...
<tr class="odd">
<td>Arbeit oder Schule-Konto</td>
...
## <a name="whitelist-example"></a>Weiße-Beispiel


Im folgenden Beispiel wird für Windows 10 Mobile lehnt alle apps und ermöglicht die folgenden apps:

-   [Settings-app, die Splash apps verwenden](#settingssplashapps)
-   Die meisten der [Posteingang apps](#inboxappsandcomponents), jedoch nicht alle.

In diesem Beispiel wird die **MobileGroup0** der Name des Knotens. Wir empfehlen die Verwendung einer GUID für diesen Knoten.
...
## <a name="recommended-deny-list-for-windows-information-protection"></a>Empfohlene Liste für Windows Information Protection verweigern
Im folgenden Beispiel wird für Windows 10 verweigert Version 1607 bekannten unenlightened Microsoft-apps auf Enterprise-Daten als eine zulässige app zugreifen. (Ein Administrator kann immer noch eine Regel ausgenommen stattdessen verwenden.) Dadurch wird sichergestellt, ein Administrator nicht versehentlich stellen diese apps Windows Information Protection zulässig, und Kompatibilität bekannten Probleme im Zusammenhang mit der automatischen Datei Verschlüsselung mit diese Anwendungen vermeiden.

In diesem Beispiel wird "Contoso" der Name des Knotens. Wir empfehlen die Verwendung einer GUID für diesen Knoten.
