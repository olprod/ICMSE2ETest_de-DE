---
title: ActiveSync DDF-Datei
description: ActiveSync DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="activesync-ddf-file"></a>ActiveSync DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter der **ActiveSync** -Konfiguration. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
...
[ActiveSync-Konfiguration-Dienstanbieter](activesync-csp.md)
