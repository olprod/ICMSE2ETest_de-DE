---
title: WindowsLicensing DDF-Datei
description: WindowsLicensing DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="windowslicensing-ddf-file"></a>WindowsLicensing DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **WindowsLicensing** -Konfiguration. DDF-Dateien werden nur mit OMA DM Bereitstellung von XML verwendet.
...
[WindowsLicensing Konfigurationsdienstanbieter](windowslicensing-csp.md)
