---
title: Defender DDF-Datei
description: Defender DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="defender-ddf-file"></a>Defender DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **Defender** -Konfiguration. DDF-Dateien werden nur mit OMA DM Bereitstellung von XML verwendet.
...
[Defender Konfiguration-Dienstanbieter](defender-csp.md)
