---
title: Aktualisieren der DDF-Datei
description: Update DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="update-ddf-file"></a>Aktualisieren der DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter des **Update** -Konfiguration. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
