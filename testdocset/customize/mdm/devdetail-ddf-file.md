---
title: DevDetail DDF-Datei
description: DevDetail DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="devdetail-ddf-file"></a>DevDetail DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **DevDetail** -Konfiguration. DDF-Dateien werden nur mit OMA DM Bereitstellung von XML verwendet.
...
[DevDetail Konfiguration-Dienstanbieter](devdetail-csp.md)
