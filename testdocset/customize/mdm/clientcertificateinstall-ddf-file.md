---
title: ClientCertificateInstall DDF-Datei
description: ClientCertificateInstall DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="clientcertificateinstall-ddf-file"></a>ClientCertificateInstall DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für **ClientCertificateInstall** -Konfiguration. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
...
[ClientCertificateInstall Konfiguration-Dienstanbieter](clientcertificateinstall-csp.md)
