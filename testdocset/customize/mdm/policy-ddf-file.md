---
title: Richtlinie DDF-Datei
description: Richtlinie DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="policy-ddf-file"></a>Richtlinie DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für die **Richtlinie** Konfiguration-Dienstanbieter. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
...
[Richtlinie Konfiguration-Dienstanbieter](policy-configuration-service-provider.md)
