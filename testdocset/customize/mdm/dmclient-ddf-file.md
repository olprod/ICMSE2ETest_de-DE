---
title: DMClient DDF-Datei
description: DMClient DDF-Datei
MSHAttr:
...
translationtype: MT
---
# <a name="dmclient-ddf-file"></a>DMClient DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den **DMClient** Konfigurationsdienstanbieter. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
...
[DMClient Konfiguration-Dienstanbieter](dmclient-csp.md)
