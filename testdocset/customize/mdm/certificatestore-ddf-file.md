---
title: CertificateStore DDF-Datei
description: "In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den Dienstanbieter für CertificateStore Konfiguration. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet."
MSHAttr:
...
translationtype: MT
---
# <a name="certificatestore-ddf-file"></a>CertificateStore DDF-Datei


In diesem Thema wird das OMA DM Gerät Beschreibung Framework (DDF) für den **CertificateStore** Konfigurationsdienstanbieter. DDF-Dateien werden nur mit OMA DM XML-Bereitstellung verwendet.
